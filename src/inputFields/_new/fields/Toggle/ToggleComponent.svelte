...
<div class="checkbox-container" class:is-enabled={value} role="switch" tabindex="0" aria-checked={value} on:click={() => toggleValue()} on:keypress={(event) => toggleValueOnKey(event)}>
